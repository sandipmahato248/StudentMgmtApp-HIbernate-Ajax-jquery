...
<!--   Navigation Bar -->
	...
	<div class="topnav">
		<%-- <a href="#"><img src="<c:url value="/theme/images/226777.svg" />"></a></span> --%>
			...
			success : function(data, textStatus, xhr) {
			 ...
			 console.log("xhr",xhr);
		        ...
		        /* for(var i=0;i<xhr.responseJSON.length;i++){
		        	console.log(xhr.responseJSON[i].defaultMessage);
		        } */
				$("#nameError").html(xhr.responseJSON[0].defaultMessage);
				$("#addressError").html(xhr.responseJSON[1].defaultMessage);
		      },
